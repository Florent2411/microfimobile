...
import { View, StyleSheet, Image,SafeAreaView, Platform, StatusBar, Text, TouchableOpacity } from 'react-native';
    ...
    return (
        <SafeAreaView style = {styles.pageContainer}> 
            ...
            <View style={styles.onboardingImageContainer}>
                <Image source={require('../assets/nerver-use-paper-illust.png')}  style = {styles.onboardingImage}/>
            </View>
            <View style={styles.onboardingTextContainer}>
                <Text style={styles.onboardingText}>Never use paper again to register your client’s contribution</Text>
                <TouchableOpacity style={styles.firstBouton} onPress={() => navigation.replace('Onboarding2')}>
