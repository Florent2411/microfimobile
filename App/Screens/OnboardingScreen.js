...
function OnboardingScreen1(OnboardingText, OnboardingImage) {
    return (
        <SafeAreaView style = {styles.pageContainer}> 
            ...
            <View style={styles.onboardingImageContainer}>
                <Image source={require('../assets/'+{OnboardingImage})}  style = {styles.onboardingImage}/>
            </View>
            <View style={styles.onboardingTextContainer}>
                <Text style={styles.onboardingText}>{{OnboardingText}}</Text>
                <TouchableOpacity style={styles.firstBouton}>
                    <Text style={styles.boutonText}>Create a free account</Text>
                </TouchableOpacity>
